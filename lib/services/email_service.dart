...
class EmailService {
  ...
  static Future<String> sendEmail({
    ...
    GoogleSignInAccount? user = googleAuthApi.currentUser;
    ...
    if (user == null) return 'Você precisa estar conectado à internet e logado com o Google para enviar o email';
